module.exports = class Data1716192789021 {
    name = 'Data1716192789021'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "list_event" ("id" character varying NOT NULL, "price" numeric NOT NULL, "seller" text NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "tx_hash" text NOT NULL, "status" character varying(8), "collection_id" character varying, "token_id" character varying, "pay_token_id" character varying, CONSTRAINT "PK_f8c492905c39ccf96389ff91cb2" PRIMARY KEY ("id"))`)
