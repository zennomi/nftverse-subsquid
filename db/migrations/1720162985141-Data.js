module.exports = class Data1720162985141 {
    name = 'Data1720162985141'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "list_event" ("id" character varying NOT NULL, "price" numeric NOT NULL, "seller" text NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "tx_hash" text NOT NULL, "status" character varying(10) NOT NULL, "auction_data" jsonb, "collection_id" character varying, "token_id" character varying, "pay_token_id" character varying, CONSTRAINT "PK_f8c492905c39ccf96389ff91cb2" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "bid_event" ("id" character varying NOT NULL, "price" numeric NOT NULL, "bidder" text NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "list_event_id" character varying, CONSTRAINT "PK_d2830927e2a0407392a94a8555a" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_6dc7fb23979257c643c6d00dfd" ON "bid_event" ("list_event_id") `)
        await db.query(`CREATE TABLE "offer_event" ("id" character varying NOT NULL, "price" numeric NOT NULL, "offerer" text NOT NULL, "owner" text NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "accepted" boolean, "collection_id" character varying, "token_id" character varying, "pay_token_id" character varying, CONSTRAINT "PK_292fd2efd338dfd5d627a4310e3" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_5e615440018c17bbf6222d9a9a" ON "offer_event" ("collection_id") `)
        await db.query(`CREATE INDEX "IDX_3064d3368021d0e45353731bb4" ON "offer_event" ("token_id") `)
        await db.query(`CREATE INDEX "IDX_06c8a6fb7d653ee928848372f7" ON "offer_event" ("pay_token_id") `)
        ...
        await db.query(`ALTER TABLE "offer_event" ADD CONSTRAINT "FK_5e615440018c17bbf6222d9a9ac" FOREIGN KEY ("collection_id") REFERENCES "collection"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
        await db.query(`ALTER TABLE "offer_event" ADD CONSTRAINT "FK_3064d3368021d0e45353731bb40" FOREIGN KEY ("token_id") REFERENCES "token"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
        await db.query(`ALTER TABLE "offer_event" ADD CONSTRAINT "FK_06c8a6fb7d653ee928848372f7c" FOREIGN KEY ("pay_token_id") REFERENCES "payment_token"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    }
    ...
    async down(db) {
        ...
        await db.query(`DROP INDEX "public"."IDX_5e615440018c17bbf6222d9a9a"`)
        await db.query(`DROP INDEX "public"."IDX_3064d3368021d0e45353731bb4"`)
        await db.query(`DROP INDEX "public"."IDX_06c8a6fb7d653ee928848372f7"`)
        ...
        await db.query(`ALTER TABLE "offer_event" DROP CONSTRAINT "FK_5e615440018c17bbf6222d9a9ac"`)
        await db.query(`ALTER TABLE "offer_event" DROP CONSTRAINT "FK_3064d3368021d0e45353731bb40"`)
        await db.query(`ALTER TABLE "offer_event" DROP CONSTRAINT "FK_06c8a6fb7d653ee928848372f7c"`)
    }
}
